...
prep_for_wordcloud <- function(data, text_column) {
  ...
  words_to_remove <- tibble(word = c("promoting", "promotion", "development", "benefit", "activites", "public", "objects","aim","advancement","purpose", "promote", "provide", "purposes", "provision", "advance"))
