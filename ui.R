          ...
          box(
            ...
            div(
              ...
              fluidRow(
                ...
                column(4, br(), actionButton("hideshow", "Hide/show extra filters"), actionButton("reset_all", "Reset all"))
              ),
              ...
              conditionalPanel(
                ...
                fluidRow(column(4, uiOutput("input_benef")), column(4, uiOutput("input_activities")), column(4, uiOutput("input_status"))),
                fluidRow(column(4, uiOutput("input_year_reg")), column(4, uiOutput("input_incom")), column(4, uiOutput("input_expend")))
              )
            )
          )
        )),
        fluidRow( valueBoxOutput("count_box") %>% withSpinner(color="#3c8dbc") , 
