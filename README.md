...
1. How many education charities are in my local area that only operate locally?
2. How do the number of sports charities within Edinburgh compared to Stirling? How many of these are for younger people?
3. I want to volunteer to a very small charity (day income less that £10k in last year) that has a main office close to me and I want to generate a list of the charities and easy links to their websites. 
4. How many charities are their in Scotland who mainly operates overseas and what are their main purposes and recent income/expentiture levels?  
